...
import { handleCreateQcl } from "../../model/services/qclService";
import { useQclModal } from "../../model/modal/useQclModal";

function CreateQclModal() {

    const { open, setOpen } = useQclModal();
        ...
        >
            <ModalBox>
                ...
                <div className="flex justify-end">
                    <Button variant="contained" onClick={() => handleCreateQcl(fetching, setFetching, name, description)}>Сохранить</Button>
                </div>
            </ModalBox>
        </Modal>
    );
