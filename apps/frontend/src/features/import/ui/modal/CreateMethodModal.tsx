...
import { handleCreateMethod } from "../../model/services/methodService";
import { useMethodModal } from "../../model/modal/useMethodModal";


function CreateMethodModal() {

    const { open, setOpen } = useMethodModal();
        ...
        >
            <ModalBox>
                ...
                <div className="flex justify-end">
                    <Button variant="contained" onClick={() => handleCreateMethod(fetching, setFetching, name, description)}>Сохранить</Button>
                </div>
            </ModalBox>
        </Modal>
    );
