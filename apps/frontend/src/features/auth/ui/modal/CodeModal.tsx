...
function CodeModal() {
    ...
    const { modal, setModal, email } = useAuthStore();
        ...
        >
            <ModalBox>
                ...
                <div className="flex justify-end gap-3">
                    <Button variant="outlined" color="error" onClick={() => setModal(false)}>Отменить</Button>
                    <Button variant="contained" onClick={() => handleCode(code)}>Подтвердить</Button>
                </div>
            </ModalBox>
        </Modal>
    );
